...
rwar_dosing <- read.csv("RWAR_dosing_cleaned.csv")
rwar_dosing$Timestamp <- ymd(rwar_dosing$Timestamp)

plot_pH <- ggplot(rwar_dosing, aes(x = Timestamp,
                           y = mean_pH,
                           color = mean_pH)) +
  geom_line() + 
  scale_color_gradient(low = 'blue', high = 'red') +
...
plot_polymer <- ggplot(rwar_dosing, aes(x = Timestamp,
...
plot_FeCl <- ggplot(rwar_dosing, aes(x = Timestamp,
                           y = Ferric.chloride..mg.L,
...
plot_temp <- ggplot(rwar_dosing, aes(x = Timestamp,
                           y = mean_Temp,
                           color = mean_Temp)) +
  geom_line() + 
  scale_color_gradient(low = 'blue', high = 'red') +
...
plot_cond <- ggplot(rwar_dosing, aes(x = Timestamp,
                           y = mean_Conductivity,
...
plot_turb <- ggplot(rwar_dosing, aes(x = Timestamp,
                           y = mean_Turbidity,
