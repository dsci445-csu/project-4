...
# 47% accuracy for just temperature and pH
...
multi_recipe1 <- recipe(FeCl_change ~ mean_pH + mean_Temp, data = df_train) |>
...
library(kableExtra) # For extra formatting

# 1. Extract the model fit object
fit_engine <- multi_fit |> extract_fit_engine()

# 2. Tidy the results using the broom package
# The tidy function converts the coefficient matrix into a clean data frame.
tidy_coeffs <- tidy(fit_engine)

# 3. Format the table using kable/kableExtra for display
tidy_coeffs |>
  ...
  # OR use kableExtra for more styling options (e.g., HTML/PDF output)
  # kableExtra::kbl(format = "html") |>
  # kableExtra::kable_styling(bootstrap_options = "striped", full_width = FALSE)
multi_fit |> extract_fit_engine() |> tibble()
```
