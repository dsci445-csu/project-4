...
![](Scooters/Discount Zones City.png){width="630"}

## Exploring Discount Zones

![](Scooters/Discount Zones Campus.png){width="515"}

## Data Collection Issues

![](Model Photos/Exploritory Segment.png){width="526"}
...
-   Real data collection is far from perfect
