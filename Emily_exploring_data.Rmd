...
## need to normalize data still, can do z score or min max, will read later
...
# df <- df %>%
#   mutate(
#     Z_Score_Weighted_Avg_Percentage = (Weighted_Average_Percentage - mean(Weighted_Average_Percentage, na.rm = TRUE)) / 
#                                       sd(Weighted_Average_Percentage, na.rm = TRUE)
#   )
```
