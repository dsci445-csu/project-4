...
names(full_merge) = c("Temperature", "pH", "Conductivity", "Turbidity", "Date", "Alkalinity",
                      "Hardness", "Cluster", "Ferric Chloride, mg/L", "Cationic Polimer, mg/L")

long_df = full_merge %>%
  pivot_longer(cols = c("Temperature", "pH", "Conductivity", "Turbidity",
