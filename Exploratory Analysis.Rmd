...
merged = df1 %>% inner_join(df2, by = "Date")
merged$Date = NULL # We already have the Timestamp column
...
ggplot(merged, aes(x = cluster_data[ , "mean_Temp"], y = cluster_data[ , "mean_pH"], # you can compare any two columns
